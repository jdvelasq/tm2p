...
## ...     n_jobs=None,
## ... )
## >>> from tm2p.packages.factor_analysis.co_occurrence import manifold_terms_by_dimension_map
## >>> plot = (
...
from tm2p.synthes.factor_anal.co_occur.terms_by_dimension_data_frame import (
