...
## ...     random_state=0,
## ... )
## >>> from tm2p.packages.factor_analysis.tfidf import cluster_centers_frame
## >>> (
...
from tm2p.synthes.factor_anal.tfidf.terms_by_dimension_dataframe import (
    terms_by_dimension_frame,
)
from tm2p.synthes.factor_anal.tfidf.terms_to_cluster_mapping import (
