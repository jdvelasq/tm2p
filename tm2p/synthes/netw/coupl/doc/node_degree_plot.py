...
Smoke tests:
    >>> from tm2p.packages.networks.coupling.documents import NodeDegreePlot
    >>> plot = (
    ...     NodeDegreePlot()
    ...     #
    ...     # UNIT OF ANALYSIS:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.coupling.documents.node_degree_plot.html")

.. raw:: html

    <iframe src="../_generated/px.packages.networks.coupling.documents.node_degree_plot.html"
...
from tm2p.synthes.netw.coupl._intern.from_documents.create_nx_graph import (
