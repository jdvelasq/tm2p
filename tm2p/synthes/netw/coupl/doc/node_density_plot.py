...
Smoke tests:
    >>> from tm2p.packages.networks.coupling.documents import NodeDensityPlot
    >>> plot = (
    ...     NodeDensityPlot()
    ...     #
    ...     # UNIT OF ANALYSIS:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.coupling.documents.node_density_plot.html")
