...
Smoke tests:
    >>> from tm2p.packages.networks.coupling.countries import NodeDensityPlot
    >>> plot = (
    ...     NodeDensityPlot()
    ...     #
    ...     # UNIT OF ANALYSIS:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.coupling.countries.node_density_plot.html")
