...
Smoke tests:
    >>> from tm2p.packages.networks.co_citation.cited_references import NodeDegreeDataFrame
    >>> (
    ...     NodeDegreeDataFrame()
    ...     #
    ...     # UNIT OF ANALYSIS:
...
from tm2p.synthes.intellect_struct.co_cit_netw._intern.node_degree_data_frame import (
