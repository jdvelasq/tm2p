...
Smoke tests:
    >>> from tm2p.packages.networks.citation.countries  import node_density_plot
    >>> plot = (
    ...     NodeDensityPlot()
    ...     #
    ...     # UNIT OF ANALYSIS:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.citation.countries.node_density_plot.html")
