...
Smoke tests:
    >>> from tm2p.packages.networks.citation.organizations import TermsByClusterDataFrame
    >>> (
...
from tm2p.synthes.intellect_struct.cit_netw._intern.from_others.terms_by_cluster_data_frame import (
