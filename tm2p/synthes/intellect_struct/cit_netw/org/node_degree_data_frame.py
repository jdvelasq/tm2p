...
Smoke tests:
    >>> from tm2p.packages.networks.citation.organizations  import NodeDegreeDataFrame
    >>> (
    ...     NodeDegreeDataFrame()
    ...     #
    ...     # UNIT OF ANALYSIS:
...
from tm2p.synthes.intellect_struct.cit_netw._intern.from_others.node_degree_data_frame import (
