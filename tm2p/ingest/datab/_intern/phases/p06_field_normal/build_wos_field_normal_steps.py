...
def build_wos_field_normal_steps(params: Params) -> list[Step]:
    ...
    from .s01_normal_wos_auth_raw import s01_normal_wos_auth_raw
    from .s02_repair_wos_authid import s02_repair_wos_authid
    ...
    return [
        Step(
            ...
            function=s01_normal_wos_auth_raw,
            kwargs=common_kwargs,
        ),
        Step(
            name="Repairing AUTHID",
            function=s02_repair_wos_authid,
            kwargs=common_kwargs,
        ),
        Step(
