...
def build_scopus_field_normal_steps(params: Params) -> list[Step]:
    ...
    from .s01_normal_scopus_auth_raw import s01_normal_scopus_auth_raw
    from .s02_repair_scopus_authid import s02_repair_scopus_authid
    ...
    return [
        Step(
            ...
            function=s01_normal_scopus_auth_raw,
            kwargs=common_kwargs,
        ),
        Step(
            name="Repairing AUTHID",
            function=s02_repair_scopus_authid,
            kwargs=common_kwargs,
        ),
        Step(
