...
def build_affiliation_steps(params: Params) -> list[Step]:
    ...
    from ._assign_region import assign_region
    from ._assign_subregion import assign_subregion
    from ._extract_organizations_and_countries import (
        extract_organizations_and_countries,
    )
