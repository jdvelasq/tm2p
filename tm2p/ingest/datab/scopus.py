...
class Scopus(BaseIngest):
    ...
    def ingestion_pipeline(self) -> tuple[tuple[str, list[Step]], ...]:
        ...
        from ._intern.phases.p04_filter import build_scopus_filter_steps
        ...
        from ._intern.phases.p07_enrich import build_scopus_enrich_steps
        from ._intern.phases.p08_kw_prepar import build_scopus_kw_prepar_steps
        ...
        return (
            (self._02_COMPRESS, build_scopus_compress_steps(self.params)),
            (self._03_PARS, build_scopus_pars_steps(self.params)),
            (self._04_FILTER, build_scopus_filter_steps(self.params)),
            (self._05_STRUCT_STAND, build_scopus_struct_stand_steps(self.params)),
            (self._06_FIELD_NORMAL, build_scopus_field_normal_steps(self.params)),
            (self._07_ENRICH, build_scopus_enrich_steps(self.params)),
            (self._08_KW_PREPAR, build_scopus_kw_prepar_steps(self.params)),
