...
.. raw:: html
    ...
    <iframe src="../_generated/px.discov.co_occur_matrix.auth_first.matrix_plot.html"
...
Smoke tests:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discov.co_occur_matrix.auth_first.matrix_plot.html")
