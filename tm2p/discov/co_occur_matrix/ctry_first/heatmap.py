...
.. raw:: html
    ...
    <iframe src="../_generated/px.discov.co_occur_matrix.ctry_first.heatmap.html"
...
Smoke tests:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discov.co_occur_matrix.ctry_first.heatmap.html")
