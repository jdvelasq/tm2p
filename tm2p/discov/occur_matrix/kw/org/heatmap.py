...
.. raw:: html
    ...
    <iframe src="../_generated/px.discov.occur_matrix.kw.org.heatmap.html"
    height="800px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from tm2p import Field, ItemsOrderBy
    >>> from tm2p.discov.occur_matrix.kw.org import Heatmap
    >>> fig = (
    ...     Heatmap()
    ...     #
    ...     # COLUMNS:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discov.occur_matrix.kw.org.heatmap.html")
